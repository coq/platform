...
COQ_PLATFORM_VERSION_TITLE="Coq 8.16+rc1 (released Jun 2022) with the old package pick from Apr 2022."
...
COQ_PLATFORM_PACKAGE_PICK_POSTFIX='~8.16+rc1~2022.04+preview'
...
COQ_PLATFORM_VERSION_DESCRIPTION+='This is a release candidate and intended for package maintainers and early adopters. '
