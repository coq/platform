...
COQ_PLATFORM_VERSION_TITLE="Coq 8.18.0 (released Jun 2023) with Coq LSP"
...
COQ_PLATFORM_VERSION_DESCRIPTION='This version of Coq Platform 2023.03.0 includes Coq 8.18.0 from Jun 2023. '
...
########## Coq Language Server ##########
PACKAGES="${PACKAGES} coq-lsp.0.2.0+8.18"
...
then
  ...
  # Coq ELPI 1.19 build system seems broken on CI :(
  #
  ...
  #
  # Require coq-elpi (which is broken)
  ...
  # EJGA: Not compatible with 8.18 yet :(
  # PACKAGES="${PACKAGES} coq-iris.4.0.0"
  # PACKAGES="${PACKAGES} coq-iris-heap-lang.4.0.0"

  # Compcert 3.13 still conflicting with 8.18...
  #
  ...
  # VST 2.12 still conflicting with 8.18...
  #
