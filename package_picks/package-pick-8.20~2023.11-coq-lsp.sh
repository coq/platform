...
COQ_PLATFORM_VERSION_TITLE="Coq 8.20.0 (released Sep 2024)"
...
COQ_PLATFORM_PACKAGE_PICK_POSTFIX='~8.20-lsp'
...
COQ_PLATFORM_VERSION_DESCRIPTION='This version of Coq Platform 2024.01.0 includes Coq 8.20.0 from Sep 2024. '
