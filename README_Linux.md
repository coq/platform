...
- The script creates a new opam switch named `_coq-platform_.master` - this means the script does not touch your existing opam setup unless you already have a switch of this name.
...
# Manual OS-platform tests run on Linux (in addition to CI)
