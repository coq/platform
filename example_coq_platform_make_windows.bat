...
CALL coq_platform_make_windows.bat ^
  ...
  -packages="8.16~2022.09" -extent=x -parallel=p -jobs=8 -switch=k -compcert=y -large=i
...
REM     -packages="8.16~2022.09" -extent=x -parallel=p -jobs=8 -switch=k -compcert=y -large=i
