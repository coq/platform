...
CALL coq_platform_make_windows.bat ^
  ...
  -packages="8.14~2021.11" -extent=x -parallel=p -jobs=16 -switch=k -compcert=y -vst=y
...
REM     -packages="8.14~2021.11" -extent=x -parallel=p -jobs=16 -switch=k -compcert=y -vst=y
