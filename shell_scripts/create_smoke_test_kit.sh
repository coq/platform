...
TEST_FILES[coq-elpi]='theories/examples/example_curry_howard_tactics.v'
...
TEST_FILES[coq-hierarchy-builder]='demo2/classical.v demo2/stage10.v'
...
TEST_FILES[coq-mtac2]='examples/tactics.v examples/tauto.v'
...
TEST_FILES[coq-vst]='progs/reverse.v progs/verif_reverse2.v'
TEST_FILES[coq-vst-64]='progs64/reverse.v progs64/verif_reverse2.v'
COQ_OPTION[coq-vst-64]='-Q $COQLIB/../coq-variant/VST64/VST VST -Q $COQLIB/../coq-variant/compcert64/compcert compcert'
