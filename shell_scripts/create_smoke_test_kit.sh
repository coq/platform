...
TEST_FILES[coq-extructures~8.19~2024.01+beta1]='tests/tutorial.v'
...
TEST_FILES[coq-mathcomp-word~8.19~2024.01+beta1]='../../test_files/coq-mathcomp-word/test.v'
...
TEST_FILES[coq-simple-io]='test/example/main.v test/extraction/main.v'
