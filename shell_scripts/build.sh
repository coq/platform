...
opam pin add -k git -n coq-core.8.17.1 https://github.com/ejgallego/coq.git#v8.17+lsp
  ...
  [pP]) 
    ...
    do
      ...
      PIN.*)
        ...
        if ! $COQ_PLATFORM_TIME opam pin add -k version ${package_name} ${package_version}; then dump_opam_logs; fi
        ;;
      esac
    done
    ;;
