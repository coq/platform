...
if ! $COQ_PLATFORM_TIME opam install --ignore-constraints-on="coq-tactician,dune,coq-core" dune.3.15.0 coq-tactician-dummy.1.0~beta2+8.17 coq-core.8.18.0 coq-tactician.1.0~beta2.1+8.18; then dump_opam_logs; fi
