# Coq Platform 2023.03.0 providing Coq 8.14.1 (released Nov 2021) with an updated package pick from Apr 2022
...
This README file is for **Coq Platform 2023.03.0 with Coq 8.14.1**.
The README files for other versions are linked in the main [README](../README.md).

This version of Coq Platform 2023.03.0 includes Coq 8.14.1 from 11/2021. There are two package picks for Coq 8.14.1: the original from 01/2022, and an updated/extended one from 03/2022. This is the latest package pick for Coq 8.14.1 with some package updates with the goal to make it as compatible as possible to the Coq 8.15.2 package pick. 
...
## **Coq Platform 2023.03.0 with Coq 8.14.1 "base level"**
...
## **Coq Platform 2023.03.0 with Coq 8.14.1 "IDE level"**
...
## **Coq Platform 2023.03.0 with Coq 8.14.1 "full level"**
...
## **Coq Platform 2023.03.0 with Coq 8.14.1 "optional packages"**
...
## **Coq Platform 2023.03.0 with Coq 8.14.1 "extended level"**
