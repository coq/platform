# Coq Platform 2022.04.1 providing Coq 8.14.1 (released Nov 2021) with an updated package pick from Apr 2022
...
This version of Coq Platform 2022.04.1 includes Coq 8.14.1 from 11/2021. There are two package picks for Coq 8.14.1: the original from 01/2022, and an updated/extended one from 03/2022. This is the latest package pick for Coq 8.14.1 with some package updates with the goal to make it as compatible as possible to the Coq 8.15.2 package pick. 
...
## **Coq Platform 2022.04.1 with Coq 8.14.1 "IDE level"**
