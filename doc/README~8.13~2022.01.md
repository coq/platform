...
# Coq Platform 2024.10.1 providing Coq 8.13.2 (released Apr 2021) with an updated package pick from Jan 2022
...
This version of Coq Platform 2024.10.1 includes Coq 8.13.2 from 04/2021. There are three package picks for Coq 8.13.2: the original from 02/2021, a substantially extended one from 09/2021 and an updated one from 11/2021. This is the latest package pick for Coq 8.13.2 with some package updates with the goal to make it as compatible as possible to the Coq 8.14.0 package pick. 
