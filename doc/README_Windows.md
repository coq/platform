...
- The script creates a new opam switch named e.g. __coq-platform.2022.09.1~8.16~2022.09 - the exact name depends on the Coq version and package pick you selected you selected.
