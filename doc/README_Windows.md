...
- In case you already have an **existing Coq Platform Cygwin** installation:
  ...
  - Download, clone or pull the Coq Platform:
    ...
    - **OR** Git update (with existing git Coq Platform repo):
      - `cd platform`
      - `git fetch & git checkout 2022.04.1`
...
- The script creates a new opam switch named e.g. __coq-platform.2022.04.1~8.15~2022.04 - the exact name depends on the Coq version and package pick you selected you selected.
