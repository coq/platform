...
# Coq Platform 2023.03.0 providing Coq 8.15.2 (released Jun 2022) with an updated package pick from Sep 2022
...
This README file is for **Coq Platform 2023.03.0 with Coq 8.15.2**.
The README files for other versions are linked in the main [README](https://github.com/coq/platform/blob/main/README.md).

This version of Coq Platform 2023.03.0 includes Coq 8.15.2 from Sep 2022. There are two package picks for Coq 8.15.2: the original from 04/2022, and an updated/extended one from 09/2022. This is the latest package pick for Coq 8.15.2 with some package updates with the goal to make it as compatible as possible to the Coq 8.16.1 package pick. 
...
## **Coq Platform 2023.03.0 with Coq 8.15.2 "base level"**
...
## **Coq Platform 2023.03.0 with Coq 8.15.2 "IDE level"**
...
## **Coq Platform 2023.03.0 with Coq 8.15.2 "full level"**
...
## **Coq Platform 2023.03.0 with Coq 8.15.2 "optional packages"**
...
## **Coq Platform 2023.03.0 with Coq 8.15.2 "extended level"**
