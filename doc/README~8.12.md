# Coq Platform 2023.03.1 providing Coq 8.12.2 (released Dec 2020) with the first package pick from Dec 2020
...
This README file is for **Coq Platform 2023.03.1 with Coq 8.12.2**.
The README files for other versions are linked in the main [README](../README.md).

This version of Coq Platform 2023.03.1 includes Coq 8.12.2 from 12/2020. The package pick is the original package pick of Coq Platform for Coq 8.12.2. 
...
## **Coq Platform 2023.03.1 with Coq 8.12.2 "base level"**
...
## **Coq Platform 2023.03.1 with Coq 8.12.2 "IDE level"**
...
## **Coq Platform 2023.03.1 with Coq 8.12.2 "full level"**
...
## **Coq Platform 2023.03.1 with Coq 8.12.2 "optional packages"**
...
## **Coq Platform 2023.03.1 with Coq 8.12.2 "extended level"**
