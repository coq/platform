...
COQ_PLATFORM_VERSION_DESCRIPTION='This version of Coq Platform 2021.09.0 includes a preview release for an interactive Ltac debugger in CoqIDE based on Coq 8.14.'
