...
COQ_PLATFORM_VERSION_TITLE="Coq 8.14.0 10/2021 with a beta package pick"
...
then
  ...
  PACKAGES="${PACKAGES} coq-hott.8.13"                # TODO: issues with latest tag - see https://github.com/HoTT/HoTT/issues/1581
